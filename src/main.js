...
GBGJ.xblack = new me.Color().parseCSS("#000000");
GBGJ.black = new me.Color().parseCSS("#1f1f1f");
GBGJ.dark  = new me.Color().parseCSS("#8c2322");
GBGJ.light = new me.Color().parseCSS("#8b956d");
GBGJ.white = new me.Color().parseCSS("#ffffff");
GBGJ.playerWeapon = "";
GBGJ.colors = [GBGJ.xblack, GBGJ.black, GBGJ.dark, GBGJ.light, GBGJ.white];
