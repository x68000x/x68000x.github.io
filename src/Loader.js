...
GBGJ.ProgressBar = me.Renderable.extend({
	...
	// LOADING BAR first number is horizontal: positive is move to right
	//  second number is vertical:   positive is move down
		GBGJ.font.draw(renderer, "LOADING BLAST CAT", 0, 110);
