...
GBGJ.PlayerEntity = me.Entity.extend({
	init : function (x, y, settings) {
		...
		this.scrollSpeed = parseFloat(GBGJ.data.options.speed_hack || "-0.0") + 0.0325;
		...
		this.renderable.addAnimation("idle", [0,1,2,3,4,5,8,9]);
		this.renderable.addAnimation("shoot", [6,7], 75);
...
// removing child will freeze the game when dying and holding buttons	
// workaround	
...
// shake more but do it shorter

		me.game.viewport.shake(10, 214, me.game.viewport.AXIS.BOTH, function() {
			me.state.change(GBGJ.states.GameOver);
		});
