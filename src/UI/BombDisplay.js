...
GBGJ.BombDisplay = me.Renderable.extend({
	init : function (settings) {
		var size = GBGJ.font.measureText("BOMBS: 5");
		this._super(
			me.Renderable,
			'init',
			[
			
			// PLACEMENT OF BOMB DISPLAY  45 is middle
				45, me.video.renderer.getHeight() - size.height + 1,
		
		
		// NUMBER OF BOMBS TEXT WIDTH -10 removes one decimal place
