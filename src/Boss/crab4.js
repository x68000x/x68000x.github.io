...
GBGJ.Crab4 = GBGJ.Boss.extend({
	init : function (x, y, settings) {
		...
		this.renderable.addAnimation("idle", [0, 1, 2, 3,4,5,6,7,8]);
		this.renderable.addAnimation("hit", [0, 9, 10, 0]);
		this.renderable.addAnimation("die", [0, 9,10,11,12]);
...
// rotator++ makes it go clockwise
// rotator-- makes it go counterclockwise	
...
// to make sense
	...
	// commented out because too many sound effects at once
...
// default is 200 setting this to 0 makes for a massive wavy bullet wave going left	
		...
		if(this.bulletTimer > 0) {
			...
			this.bulletTimer = 0;
			me.audio.play("enemyshoot" , false, null, 0.3);
		}
	},
