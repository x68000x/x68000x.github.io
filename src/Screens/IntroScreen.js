...
GBGJ.IntroScreen = me.ScreenObject.extend({
	...
	onResetEvent: function() {
		this.radmars = new GBGJ.BlastCatIntro();
...
GBGJ.BlastCatIntro = me.Renderable.extend({
	init: function() {
		...
		//  INTRO SCREEN MOVING OBJECT
		// first number is horizontal: negative number moves left to right
		// positive number from right to left
		
		// second number is vertical: positive move from bottom up
		// negative number from top down
		
		
		this.glasses1 = new me.Sprite(cx - glassesXOffset - 300, 0, {image: "intro_glasses1"});
		...
		var textY = cy - 50 - me.loader.getImage("intro_mars").height
        // INTRO TEXT GRAPHIC TOP negative cx number moves picture left
		this.text_mars     = new me.Sprite(cx - 80,      textY, {image: "intro_mars"});
		this.text_radmars1 = new me.Sprite(cx - 80, textY, {image: "intro_radmars1"});
		this.text_radmars2 = new me.Sprite(cx - 80, textY, {image: "intro_radmars2"});
