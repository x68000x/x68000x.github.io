...
GBGJ.CreditsRenderable = me.Renderable.extend({
	...
	draw: function(renderer) {
		...
		GBGJ.font.draw(renderer, "PROGRAMMING: ",   0,  0);
		GBGJ.font.draw(renderer, "EMARCOTTE ",     30, 10);
		GBGJ.font.draw(renderer, "HECKBRINGER",    30, 20);
		GBGJ.font.draw(renderer, "ROUSHEY",        30, 30);
		GBGJ.font.draw(renderer, "EFF BEE EYE",        30, 40);
		GBGJ.font.draw(renderer, "GFX + LEVELS:",   0, 50);
		GBGJ.font.draw(renderer, "EFF BEE EYE",        30, 60);
		GBGJ.font.draw(renderer, "SOUND + MUSIC:",  0, 70);
		GBGJ.font.draw(renderer, "EFF BEE EYE",       30, 80);
	},
